...
import {MaliciousCoinbase} from "./mocks/MaliciousCoinbase.sol";
...
contract AutoSniperTest is Test {
    ...
    uint256 seaportPrice = 490000000000000000;
    ...
    function testSendDirectTipToCoinbase() public {
        ...
        sniper.sendDirectTipToCoinbase(order, claims);
    }

    function testMaliciousCoinbaseAddress() public {
        MaliciousCoinbase coinbase = new MaliciousCoinbase();
        ...
        // should revert due to over/underflow
        vm.expectRevert();
        sniper.fulfillOrder(order, claims, 0);
    }
